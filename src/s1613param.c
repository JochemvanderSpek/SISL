...
/*
 *
 * $Id: s1613param.c,v 1.3 2001-03-19 15:58:51 afr Exp $
 *
 */
...
void 
s1613param(SISLCurve *pc,double aepsge,double **gpoint,double **out_par,int *jnbpnt, int *jstat)
#else
void s1613param(pc,aepsge,gpoint,jnbpnt,out_par,jstat)
     SISLCurve  *pc;
     double aepsge;
     double **gpoint;
     double **out_par;
...
*              out_par   - Array containing the parameter values.
*                         Array are allocated inside this function,
...
*              
*
* WRITTEN BY : Arne Laksaa, SI, 10.90. - augmented by J van der Spek j@borges.xyz
